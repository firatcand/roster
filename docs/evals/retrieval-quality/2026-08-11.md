...
- commit: `3bfa95f716a0232a560c9828a95dc8440a417639`
...
| graph/unavailable-in-every-query | pass | the cited engine reports graph expansion unavailable for every gold query |
...
Deterministic statement cost per retrieval, on each family's representative query: baseline 10, exclusion 10, precedence 10, alias-variant 10, multi-record 10, ordering 10, paraphrase-ordering 10. Warm max-of-five `transactionMs + embedMs` per family: baseline 16 ms, exclusion 16 ms, precedence 23 ms, alias-variant 15 ms, multi-record 15 ms, ordering 24 ms, paraphrase-ordering 23 ms; report-only p95 over 30 warm runs of one representative query: 16 ms.
