...
// auditAgentEnvPermissions (check 13) tests moved to test/doctor-v1-checks.test.ts (ROS-88).
// The writeAgentEnv helper stays here — used by the runSecretsAudit integration test below.
...
// (Test bodies deleted — see test/doctor-v1-checks.test.ts.)
...
// auditEnvKeyReferences unit tests moved to test/doctor-v1-checks.test.ts (ROS-88).
