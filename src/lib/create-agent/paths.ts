...
export function agentDirs(fn: string, agent: string): string[] {
  ...
  return [
    ...
    `${root}/projects/_template/config`,
    `${root}/projects/_template/playbook`,
    `${root}/projects/_template/log`,
    `${root}/projects/_template/log/runs`,
    `${root}/projects/_template/log/feedback`,
  ];
}
...
export function agentFiles(input: FileOrderInput): string[] {
  ...
  return [
    ...
    `${root}/projects/_template/config/default.yaml`,
    `${root}/projects/_template/asset-references.md`,
    `${root}/playbook/.gitkeep`,
    `${root}/logs/.gitkeep`,
    `${root}/.claude/skills/.gitkeep`,
    `${root}/.claude/plugins/.gitkeep`,
    `${root}/projects/_template/playbook/.gitkeep`,
    `${root}/projects/_template/log/runs/.gitkeep`,
    `${root}/projects/_template/log/feedback/.gitkeep`,
    `${root}/agent.md`,
  ];
}
